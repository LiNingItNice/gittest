...
public class ErpQddbdmxUpdate extends Model<ErpQddbdmxUpdate> {
    ...
    private BigDecimal glckj;

    private BigDecimal glzk;

    private BigDecimal gldj;

    private BigDecimal glje;

    private BigDecimal shfcbdj;
