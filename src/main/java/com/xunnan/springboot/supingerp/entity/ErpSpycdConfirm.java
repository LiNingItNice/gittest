...
public class ErpSpycdConfirm extends Model<ErpSpycdConfirm> {
    ...
    @TableField("Is_Move_SH")
    private String isMoveSh;

    @TableField("MoveRq_SH")
    private LocalDateTime moverqSh;
