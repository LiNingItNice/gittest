...
public class ErpSpjhdConfirm extends Model<ErpSpjhdConfirm> {
    ...
    private String hgpck;

    private String hgpkw;
    ...
    private String pmtzdh;

    private BigDecimal djkye;
